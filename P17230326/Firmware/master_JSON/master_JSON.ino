...
const char* ssid = "TP-Link_EAB8"; //TP-Link_EAB8
...
const int SOUND_START_SETUP       = 1;
const int SOUND_START_MEASURING   = 2;
const int SOUND_KO_ON_DINH        = 3;
const int SOUND_WELCOME           = 4;
const int SOUND_PATIENT_LIST_READY= 5;
const int SOUND_NO_PATIENT        = 6;
const int SOUND_SELECTED          = 7;
const int SOUND_BACK_TO_LIST      = 8;
const int SOUND_NEXT_PATIENT      = 9;
const int SOUND_MEASURING_GUIDE   = 10;
const int SOUND_MEASUREMENT_COMPLETE = 11;
const int SOUND_ANALYZING         = 12;
const int SOUND_OFFLINE_SAVED     = 13;
const int SOUND_SYNC_SUCCESS      = 14;
const int SOUND_CONNECT_FAIL      = 15;
const int SOUND_THANK_YOU         = 17;
...
void finishRefresh() {
  ...
  if (patients.empty()) {
    playSound(SOUND_NO_PATIENT);
  } else {
    playSound(SOUND_PATIENT_LIST_READY);
  }
...
void OnDataRecv(const esp_now_recv_info_t *info, const uint8_t *data, int len) {
  ...
  if (strcmp(msg.type, "data") == 0) {
    ...
    playSound(SCENARIO_BASE + scenIdx);
